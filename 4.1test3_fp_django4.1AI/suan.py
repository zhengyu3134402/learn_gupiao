...
def compute_after_20_result(four_days):
    ...
    # ============================================
    # a = four_days[-6].zg / four_days[-7].sp

    if four_days[-9].sp / four_days[-10].sp > 1.095 and \
            four_days[-10].sp / four_days[-11].sp < 1.05 and \
            four_days[-7].sp / four_days[-9].sp < 0.96 and \
            four_days[-7].sp / four_days[-9].sp >0.88:
    # ============================================
    # 0.91~1.10 : %s
    # 0.990~1.110 %st
        ...
        make_s = Second(name='%s' % (), code=four_days[-6].code, date=four_days[-6].date,
